        ...
        <div className='p-5'>
            ...
            <Accordion defaultActiveKey="0">
                <Accordion.Item eventKey="0">
                    <Accordion.Header>Système d'exploitation</Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header>Antivirus</Accordion.Header>
                    <Accordion.Body>
                        <div className='m-3 d-flex justify-content-around flex-wrap'>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 890</Button>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 860</Button>
                ...
                <Accordion.Item eventKey="2">
                    <Accordion.Header>Fierwall</Accordion.Header>
                    <Accordion.Body>
                        <div className='m-3 d-flex justify-content-around flex-wrap'>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 890</Button>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 860</Button>
                ...
                <Accordion.Item eventKey="3">
                    <Accordion.Header>Langage de développement</Accordion.Header>
                    <Accordion.Body>
                        <div className='m-3 d-flex justify-content-around flex-wrap'>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 890</Button>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 860</Button>
                ...
                <Accordion.Item eventKey="4">
                    <Accordion.Header>Utilitaires</Accordion.Header>
                    <Accordion.Body>
                        <div className='m-3 d-flex justify-content-around flex-wrap'>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 890</Button>
                            <Button variant="outline-danger" className='m-1' >Routeur Cisco 860</Button>
